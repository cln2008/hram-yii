...
*/
 ...
 echo "<h3 style='text-align: center;'><i>Порядок звершення служб в храмі Святого Георгія Побідоносця <br> СЕРПЕНЬ 2017 року</i></h3>";
  ...
  <table style="border-collapse: collapse;">
      <tr>
       <?php foreach($a as $item): ?>
           <td style="width: 150px; border: 1px solid black; text-align: center; height: 30px;"><b><?= $item ?></b></td>
       <?php endforeach; ?>
      </tr>
      ...
      <?php foreach($aw as $weekItems): ?>
          <tr>
            <?php foreach($weekItems AS $item): ?>
             <td style="width: 150px; height: 110px; vertical-align: top; text-align: center;  border: 1px solid black; ">
                <?php
